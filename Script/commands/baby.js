  ...
  try {
    ...
    if (
      ...
      const greetings = [
        ...
        "আমাকে সিজুকা না বলে , বস শামিম  কে জানু বল জানু 😘",
        ...
        "আরে বোকা সিজুকা না জানু বল জানু😌",
        "বলো জানু 🌚",
        ...
        "আমাকে এতো না ডেকে বস শামিম  এর কে একটা গফ দে 🙄",
        "আমাকে এতো না ডেকছ কেন ভলো টালো বাসো নাকি🤭🙈",
        "🌻🌺💚-আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ-💚🌺🌻",
        "আমি এখন বস শামিম  এর সাথে বিজি আছি আমাকে ডাকবেন না-😕😏 ধন্যবাদ-🤝🌻",
        ...
        "চুনা ও চুনা আমার বস শামিম  এর হবু বউ রে কেও দেকছো খুজে পাচ্ছি না😪🤧😭",
        ...
        "- ভালোবাসা নামক আব্লামি করতে মন চাইলে আমার বস শামিম  এর ইনবক্স চলে যাও-🙊🥱👅 🌻𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/100001039692046",
        ...
        "সুন্দর মাইয়া মানেই-🥱আমার বস শামিম 'র বউ-😽🫶আর বাকি গুলো আমার বেয়াইন-🙈🐸🤗",
        ...
        "মেয়ে হলে বস শামিমের ইনবক্সে চলে যা 🤭🤣😼 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/100001039692046",
    ...
    if (
      ...
      raw.startsWith("xan ") ||
      raw.startsWith("জান ") ||
      raw.startsWith("সিজুকা ") ||
      raw.startsWith("বেবি ")
    ) {
      const query = raw
        .replace(
          /^baby\s+|^bot\s+|^bby\s+|^jan\s+|^xan\s+|^জান\s+|^সিজুকা\s+|^বেবি\s+/i,
          ""
        )
        .trim();
      if (!query) return;
