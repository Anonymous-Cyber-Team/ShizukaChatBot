...
module.exports.handleEvent = async ({ event, api, Users }) => {
 ...
 "বালের সিজুকা", "ভোদার সিজুকা", "ধোনের সিজুকা", "তোর বস রে চুদি", "সিজুকা যে চুদি",
 "sahadat mc", "mc Sahu", "bokachoda sahu", "fuck you", "sex", "sexy",
 "hedar bot", "সিজুকা চুদি", "crazy bot", "bc bot", "khankir polar bot",
 "bot tor heda", "হেড়ার সিজুকা", "bot paylac rồi", "con bot lòn", "cmm bot",
